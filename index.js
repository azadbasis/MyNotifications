        ...
        return admin.firestore().collection("Users").doc(user_id)
            .collection("Notifications").doc(notification_id).get().then(queryResult => {
                ...
                return Promise.all([from_data, to_data]).then(result => {
                    ...
                    console.log("FROM: " + from_name + "| TO: " + to_name + "| Token: " + token_id);
                    ...
                    const payload = {
                        notification: {
                            ...
                            body: from_message,
                            icon: "default",
                            click_action: "com.mynotifications.TARGETNOTIFICATION"
                        },
                        data: {
                    ...
                    return admin.messaging().sendToDevice(token_id, payload).then(reasult => {
